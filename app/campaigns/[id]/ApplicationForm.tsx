  ...
  if (submitted) {
    return (
      <div className="text-center py-6">
        ...
        <h3 className="font-playfair text-xl text-brand-black mb-1">¡Solicitud recibida!</h3>
        <p className="font-dm-sans text-sm text-gray-500">Te contactaremos cuando revisemos tu solicitud.</p>
      </div>
    )
  }
