            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              {hasEliteFeatures(level) ? (
                <div className="flex flex-col gap-4">
                  {creator.account_manager_name && (
                    <div className="bg-white rounded-2xl border border-amber-200/60 p-5 flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="font-dm-sans text-xs font-semibold uppercase tracking-widest text-amber-600 mb-0.5">Your Account Manager</p>
                  ...
                  {creator.whatsapp_number && (
                    <div className="bg-amber-50 rounded-2xl border border-amber-200/60 p-5">
                      <p className="font-dm-sans text-xs font-semibold uppercase tracking-widest text-amber-600 mb-2">Elite Direct Line</p>
                      <a
                  ...
                  {creator.mastermind_date && (
                    <div className="bg-white rounded-2xl border border-amber-200/60 p-5">
                      <p className="font-dm-sans text-xs font-semibold uppercase tracking-widest text-amber-600 mb-1">Next Mastermind</p>
                      <p className="font-playfair text-xl text-brand-black">
                        {new Date(creator.mastermind_date).toLocaleDateString('en-US', {
                ...
                <div className="bg-white rounded-2xl border border-brand-green/20 p-6 flex flex-col gap-4">
                  <div>
                    <p className="font-dm-sans text-xs font-semibold uppercase tracking-widest text-brand-green mb-1">Your Account Manager</p>
                    {creator.account_manager_name ? (
                      <>
                      ...
                      <p className="font-dm-sans text-sm text-gray-400">Your manager will be assigned soon.</p>
                    )}
                  </div>
                  <div className="mt-auto pt-3 border-t border-gray-50">
                    <p className="font-dm-sans text-xs text-gray-400">Pro perk: monthly 1:1 strategy calls included.</p>
                  </div>
                </div>
              ) : (
